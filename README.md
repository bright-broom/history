...
掲載データの出典には、機関・資料名と確認できるURLを記載してください。
日付はグレゴリオ暦で統一し、旧暦・現地日付との違い、発生日と公表日・施行日の違いを確認します。
被害者数などは集計対象期間・推計であることを明示し、異なる集計基準を混ぜないでください。
[全34件の歴史データ監査記録](docs/historical-content-audit.md)に、修正・除外の理由と参照資料を記載しています。
